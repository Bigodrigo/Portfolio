export const WebData = [
    {
        ...
        description: 'Este site facilita o envio de mensagens personalizadas para um celular que tenha a App Saúde instalado. Recomendo fortemente observar o App Saúde junto deste projeto!',
