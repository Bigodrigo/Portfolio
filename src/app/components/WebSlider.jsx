    ...
    <div className="max-w-[1240px] mx-auto">
      <div className="relative flex justify-center p-4">
        ...
        <Image
            ...
            height={540}
        />
        <div className="w-960 h-540 bg-palet-two-qua m-7 p-4 text-justify flex flex-col justify-center rounded-2xl">
            <h4 className="text-3xl font-bold py-2 px-5 text-palet-two-pri text-center">
            {WebData[current].title}
            </h4>
            <p className="text-xl p-2 text-palet-two-pri">
            {WebData[current].description}
            </p>
            <div className="flex flex-col items-center mt-auto">
            <p className="text-xl p-2 text-palet-two-pri">You can visit this project at:</p>
            <div className="text-xl p-2 text-palet-two-qui text-center">
            ...
            <div className="flex flex-col items-center mt-auto">
            <p className="text-xl p-2 text-palet-two-pri">You can learn more about this at:</p>
            <div className="text-xl p-2 text-palet-two-qui text-center">
